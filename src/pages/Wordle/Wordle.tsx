...
import { WordlyFuncButtons } from '../../components/games/Wordly/WordlyFuncButtons/WordlyFuncButtons'
import { WordlyGrid } from '../../components/games/Wordly/WordlyGrid/WordlyGrid'
...
export const Wordle = () => {
	...
	return (
		<div className='wordle'>
			...
			<Keyboard />
			{/*<div>
				{russianAlphabetKeyboard.map(letter => (
					<button
						key={letter}
						style={{ padding: '8px' }}
						onClick={() =>
